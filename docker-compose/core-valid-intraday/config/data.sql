...
INSERT INTO parameter (id, name, display_order, parameter_type, section_title, section_order, parameter_value)
VALUES ('PONDERATION_CLOSEST', 'PONDERATION CLOSEST' , 1, 'INT', 'VERTICES SELECTION PONDERATION', 3, '33')
    ON CONFLICT (id) DO
UPDATE SET name = 'PONDERATION CLOSEST', display_order = 1, parameter_type = 'INT', section_title = 'VERTICES SELECTION PONDERATION', section_order = 3;
INSERT INTO parameter (id, name, display_order, parameter_type, section_title, section_order, parameter_value)
VALUES ('PONDERATION_ANGLE', 'PONDERATION ANGLE' , 2, 'INT', 'VERTICES SELECTION PONDERATION', 3, '33')
    ON CONFLICT (id) DO
UPDATE SET name = 'PONDERATION ANGLE', display_order = 2, parameter_type = 'INT', section_title = 'VERTICES SELECTION PONDERATION', section_order = 3;
INSERT INTO parameter (id, name, display_order, parameter_type, section_title, section_order, parameter_value)
