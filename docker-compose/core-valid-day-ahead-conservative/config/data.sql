...
VALUES ('USE_PROJECTION', 'USE PROJECTION', 1, 'BOOLEAN', 'PROJECTION AND AHC IMPORT ', 1, 'true')
    ON CONFLICT (id) DO
UPDATE SET name = 'USE PROJECTION', display_order = 1, parameter_type = 'BOOLEAN', section_title = 'PROJECTION AND AHC IMPORT', section_order = 1;

INSERT INTO parameter (id, name, display_order, parameter_type, section_title, section_order, parameter_value)
VALUES ('USE_AHC', 'USE AHC', 1, 'BOOLEAN', 'PROJECTION AND AHC IMPORT', 1, 'false')
    ON CONFLICT (id) DO
UPDATE SET name = 'USE AHC', display_order = 1, parameter_type = 'BOOLEAN', section_title = 'PROJECTION AND AHC IMPORT', section_order = 1;
...
INSERT INTO parameter (id, name, display_order, parameter_type, section_title, section_order, parameter_value)
VALUES ('RAM_THRESHOLD', 'RAM THRESHOLD', 2, 'INT', 'BRANCH MAX IVA', 2, '-15')
    ON CONFLICT (id) DO
...
INSERT INTO parameter (id, name, display_order, parameter_type, section_title, section_order, parameter_value)
    VALUES ('PREVENTIVE_IVA_MARGIN', 'PREVENTIVE IVA MARGIN', 2, 'INT', 'IVA MARGINS', 3, '0')
    ON CONFLICT (id) DO
...
INSERT INTO parameter (id, name, display_order, parameter_type, section_title, section_order, parameter_value)
    ...
    ON CONFLICT (id) DO
UPDATE SET name = 'JUSTIFICATION MESSAGE', display_order = 1, parameter_type = 'STRING', section_title = 'OUTPUT', section_order = 4;
