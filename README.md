...
kubectl create secret generic gridcapa-sftp-credentials --from-literal='sftp-host=<SFTP_HOST>' --from-literal='sftp-user=<SFTP_USER>' --from-literal='sftp-password=<SFTP_PASSWORD>' --from-literal='sftp-root-directory=<SFTP_ROOT_DIRECTORY>'
